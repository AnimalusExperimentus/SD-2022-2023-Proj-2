...
C_OBJS = tree_client.o client_stub.o network_client.o sdmessage.pb-c.o network-private.o
C_HDRS = client_stub.h network_client.h sdmessage.pb-c.h network-private.h
